...
@Generated(
    ...
    date = "2022-02-10T10:37:59.920219+01:00",
...
public class LaboratoryTestResultAnyEventPointEvent implements PointEventEntity, LaboratoryTestResultAnyEventChoice {
  /**
   * Path: ErrorTest/Laboratory test result/Any event/Test name
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Any event/Tree/Test name/null_flavour
   */
  @Path("/data[at0003]/items[at0005]/null_flavour|defining_code")
  private NullFlavour testNameNullFlavourDefiningCode;

  /**
   * Path: ErrorTest/Laboratory test result/Any event/Specimen
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Any event/Test result
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Any event/Structured test diagnosis
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Any event/Multimedia representation
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Any event/Structured confounding factors
