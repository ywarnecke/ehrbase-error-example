...
@Generated(
    ...
    date = "2022-02-10T10:37:59.902125+01:00",
...
public class LaboratoryTestResultObservation implements EntryEntity {
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Receiving laboratory
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Testing details
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Extension
  ...
  /**
   * Path: ErrorTest/Laboratory test result/Any event
